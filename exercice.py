...
def get_recipes():
    ...
    name = input('Entrer le nom de la recette:\n')
    ingredients = input("Entrer la liste d'ingrédient de la recette, séparer les ingrédients par une virgule:\n").split(",")
